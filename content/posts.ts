...
export const posts: Post[] = [
  {
    ...
    body: [
      ...
      { heading: 'Why a fixed rate is not a forecast' },
      ...
      { heading: 'What the honest version looks like' },
      ...
      { heading: 'When it is too small to matter' },
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'How wide the error bars actually are' },
      ...
      { heading: 'Most short-window moves are noise' },
